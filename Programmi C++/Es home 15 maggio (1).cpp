...
void vistel(struct tma,struct tmod,struct tadp,struct tp){
	cout<<"il telefono piu' costoso e' il: "<<tma<<" "<<tmod<<endl<<"anno di produzione: "<<tadp<<endl<<"costo: "<<tp<<" euro"<<endl<<endl;
}
